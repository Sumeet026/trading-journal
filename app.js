...
function renderAnalyticsReports() {
  ...
  // Draw page charts
  renderStrategyPerformance("chartStrategyPerformance", state.trades);
  renderDailyPnL("chartDailyPerformance", state.trades);
  renderWeeklyPnL("chartWeeklyPerformance", state.trades);
  renderMonthlyPnL("chartMonthlyPerformance", state.trades);
  renderPnLDistribution("chartPnLDistribution", state.trades);
}
